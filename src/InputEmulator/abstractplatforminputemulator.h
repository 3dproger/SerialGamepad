...
public:
    ...
    virtual void emulateMouseWheelSpeed(double x, double y) = 0;
    virtual bool isMouseWheelSpeedAvailable() const = 0;
    virtual void emulateMouseWheelClick(InputEmulatorTypes::MouseWheelClick x, InputEmulatorTypes::MouseWheelClick y) = 0;
